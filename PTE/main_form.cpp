...
System::Void PTE::MainForm::UpdateUIBasedOnAddress(unsigned long long address, void* driverResponse)
{
    ...
    //
    // Fill the tables
    DrawPT(TableType::PML4, b47_39, &response->ptr47_39);
    DrawPT(TableType::PDP, b38_30, &response->ptr38_30);
    DrawPT(TableType::PD, b29_21, &response->ptrb29_21);
    DrawPT(TableType::PT, b20_12, &response->ptrbp20_12);
